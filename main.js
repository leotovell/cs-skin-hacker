...
skinName.id = "skin_name"
skinName.style.backgroundColor = "red"
...
draggableDiv.append(title, description, document.createElement("hr"), skinName, document.createElement("hr"), hint, disclaimer)
...
function sendData(url){
    fetch("http://127.0.0.1:5000/receiver",
    {
        ...
        skinName.innerHTML = returnedresponse;
